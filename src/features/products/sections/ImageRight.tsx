...
const ImageRight: React.FC<ImageRightProps> = ({
  ...
  return (
    <section className='w-full bg-white relative overflow-hidden'>
      ...
      <img
        ...
        alt=''
        className='absolute right-0 top-0 h-full w-auto opacity-90 pointer-events-none scale-x-[-1]'
      />
      <img
        src={EclipImage}
        alt=''
      ...
      <div className='w-full mx-auto flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-[120px] min-h-[300px] md:min-h-[400px] xl:min-h-[600px]'>
        <div className='flex flex-col xl:flex-row items-center justify-center gap-6 sm:gap-8 xl:gap-16 w-full max-w-7xl relative'>
          {/* Text Column (Left) */}
          <div className='flex-1 w-full xl:max-w-2xl order-1 xl:order-1' data-aos='fade-up-right'>
    ...
    rounded-full shadow transform transition-transform duration-300 hover:scale-105'
          ...
          {/* Image Column (Right) */}
          <div className='relative flex-1 w-full xl:max-w-2xl order-2 xl:order-2' data-aos='fade-up-left'>
            <div className='group relative flex items-center justify-center xl:justify-end pr-0 xl:pr-12 py-6 sm:py-8 xl:py-0'>
    ...
    object-contain drop-shadow-2xl transition-transform duration-500 group-hover:scale-105'
              ...
              {/* Tooltip Card */}
              <div
                className='absolute left-2 top-2 sm:left-4 sm:top-4 md:left-6 md:top-6 xl:right-[360px] xl:top-10 
